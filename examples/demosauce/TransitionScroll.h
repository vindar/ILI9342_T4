...
void TransitionScroll::init(ILI9342Wrapper & tft) {
	_pixels = (uint16_t*)malloc( sizeof(uint_fast16_t) * tft.width() );
}

void TransitionScroll::restart(ILI9342Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionScroll::perFrame(ILI9342Wrapper & tft, FrameParams frameParams ) {
