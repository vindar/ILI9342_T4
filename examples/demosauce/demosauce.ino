/***************************************************
 ...
 https://github.com/zkarcher/demosauce
  ...
  Adapted from  https://github.com/KurtE/ILI9342_t3n/tree/master/examples/DemoSauce
  to use the ILI9342_T4 library
 ****************************************************/
...
ILI9342Wrapper tft(PIN_CS, PIN_DC, PIN_SCK, PIN_MOSI, PIN_RESET, PIN_TOUCH_MISO, PIN_TOUCH_CS, PIN_TOUCH_IRQ);

ILI9342_T4::DiffBuffStatic<40000> diff1;
ILI9342_T4::DiffBuffStatic<40000> diff2;
...
void setup()
    ...
    tft.setCanvas(fb, LX, LY); // set the framebuffer we draw onto (extended method from ILI9342Wrapper).


    // Microphone
    pinMode(MIC_PIN, INPUT);

    tft.fillScreen(ILI9342_BLACK);
    ...
    tft.setRotation(0); // ribbon cable on left
    tft.setScroll(0);
