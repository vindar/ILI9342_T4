...
void TransitionDither::init(ILI9342Wrapper & tft) {

}

void TransitionDither::restart(ILI9342Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionDither::perFrame(ILI9342Wrapper & tft, FrameParams frameParams ) {
