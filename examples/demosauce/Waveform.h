...
void Waveform::init(ILI9342Wrapper & tft) {
  _bgColor = color565( 0, 0, 0x55 );
}
...
void Waveform::perFrame(ILI9342Wrapper & tft, FrameParams frameParams ) {
  ...
  uint_fast16_t bodyColor = color565( bright, bright, 0 );  // yellow
  ...
  uint_fast16_t bgColor = color565( 0, 0, bgBright );
