...
void TransitionSquares::init(ILI9342Wrapper & tft) {

}

void TransitionSquares::restart(ILI9342Wrapper & tft, uint_fast16_t inColor ) {
...
void TransitionSquares::perFrame(ILI9342Wrapper & tft, FrameParams frameParams ) {
