...
void TriangleWeb::init(ILI9342Wrapper & tft) {
  ...
  _bgColor = color565( 0x22, 0x22, 0x22 );
}
...
void TriangleWeb::perFrame(ILI9342Wrapper & tft, FrameParams frameParams ) {
  //uint_fast16_t w = tft.width();
  //uint_fast16_t h = tft.height();
  ...
  uint_fast16_t color = color565( bright, bright, bright );
  ...
  uint_fast16_t luckyColor = color565( luckyBright, luckyBright, luckyBright );
