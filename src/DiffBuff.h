...
#ifndef _ILI9342_T4_DIFFBUFF_H_
#define _ILI9342_T4_DIFFBUFF_H_
...
namespace ILI9342_T4
{
    ...
    *******************************************************************************************/
    ...
    public:
        ...
        static const int LY = 240;                  // framebuffer height in orientation 0
        static const int MAX_WRITE_LINE = 80;       // max number of lines to be written in a single operation.
    ...
    *******************************************************************************************/
    ...
    public:
        ...
        **/
        ILI9342_T4::StatsVar statsTime() const { return _stats_time; }
        ...
        **/
        ILI9342_T4::StatsVar statsSize() const { return _stats_size; }
    ...
    private:
        ...
        ILI9342_T4::StatsVar _stats_size;   // statistics on buffer size
        ILI9342_T4::StatsVar _stats_time;   // statistics on compute times. 


        /** Read a value */
        uint32_t _read_encoded(int & pos) ILI9342_T4_ALWAYS_INLINE
            {
        ...
        void _write_encoded(uint32_t val)  ILI9342_T4_ALWAYS_INLINE
            {
            if (val <= 127)
