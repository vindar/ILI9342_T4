/******************************************************************************
*  ILI9342_T4 library for driving an ILI9342 screen via SPI with a Teensy 4/4.1
...
#include "ILI9342Driver.h"
#include "font_ILI9342_T4.h"

#include <SPI.h>



namespace ILI9342_T4
{


/** ILI9342 command codes */

#define ILI9342_T4_NOP 0x00
#define ILI9342_T4_SWRESET 0x01
#define ILI9342_T4_RDDID 0x04
#define ILI9342_T4_RDDST 0x09

#define ILI9342_T4_SLPIN 0x10
#define ILI9342_T4_SLPOUT 0x11
#define ILI9342_T4_PTLON 0x12
#define ILI9342_T4_NORON 0x13

#define ILI9342_T4_RDMODE 0x0A
#define ILI9342_T4_RDMADCTL 0x0B
#define ILI9342_T4_RDPIXFMT 0x0C
#define ILI9342_T4_RDIMGFMT 0x0D
#define ILI9342_T4_RDSGNMODE 0x0E
#define ILI9342_T4_RDSELFDIAG 0x0F

#define ILI9342_T4_INVOFF 0x20
#define ILI9342_T4_INVON 0x21
#define ILI9342_T4_GAMMASET 0x26
#define ILI9342_T4_DISPOFF 0x28
#define ILI9342_T4_DISPON 0x29

#define ILI9342_T4_CASET 0x2A
#define ILI9342_T4_PASET 0x2B
#define ILI9342_T4_RAMWR 0x2C
#define ILI9342_T4_RAMRD 0x2E

#define ILI9342_T4_PTLAR 0x30
#define ILI9342_T4_MADCTL 0x36
#define ILI9342_T4_VSCRSADD 0x37
#define ILI9342_T4_PIXFMT 0x3A

#define ILI9342_T4_GSLINE 0x45

#define ILI9342_T4_FRMCTR1 0xB1
#define ILI9342_T4_FRMCTR2 0xB2
#define ILI9342_T4_FRMCTR3 0xB3
#define ILI9342_T4_INVCTR 0xB4
#define ILI9342_T4_DFUNCTR 0xB6

#define ILI9342_T4_PWCTR1 0xC0
#define ILI9342_T4_PWCTR2 0xC1
#define ILI9342_T4_PWCTR3 0xC2
#define ILI9342_T4_PWCTR4 0xC3
#define ILI9342_T4_PWCTR5 0xC4
#define ILI9342_T4_VMCTR1 0xC5
#define ILI9342_T4_VMCTR2 0xC7

#define ILI9342_T4_RDID1 0xDA
#define ILI9342_T4_RDID2 0xDB
#define ILI9342_T4_RDID3 0xDC
#define ILI9342_T4_RDID4 0xDD

#define ILI9342_T4_GMCTRP1 0xE0
#define ILI9342_T4_GMCTRN1 0xE1
#define ILI9342_T4_PWCTR6  0xFC


#define ILI9342_T4_MADCTL_MY  0x80
#define ILI9342_T4_MADCTL_MX  0x40
#define ILI9342_T4_MADCTL_MV  0x20
#define ILI9342_T4_MADCTL_ML  0x10
#define ILI9342_T4_MADCTL_RGB 0x00
#define ILI9342_T4_MADCTL_BGR 0x08
#define ILI9342_T4_MADCTL_MH  0x04
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM ILI9342Driver::ILI9342Driver(uint8_t cs, uint8_t dc, uint8_t sclk, uint8_t sda, uint8_t rst, uint8_t touch_miso, uint8_t touch_cs, uint8_t touch_irq)
        {
        // general
        _width = ILI9342_T4_TFTWIDTH;
        _height = ILI9342_T4_TFTHEIGHT;
        _rotation = 0;
        _refreshmode = 0; 
        _irq_priority = ILI9342_T4_DEFAULT_IRQ_PRIORITY;
        _outputStream = nullptr;

        // buffering
        _late_start_ratio = ILI9342_T4_DEFAULT_LATE_START_RATIO;
        _late_start_ratio_override = true;
        _diff_gap = ILI9342_T4_DEFAULT_DIFF_GAP;
        _vsync_spacing = ILI9342_T4_DEFAULT_VSYNC_SPACING;
        _diff1 = nullptr;
        _diff2 = nullptr;
        _fb1 = nullptr;
        _dummydiff1 = &_dd1;
        ...
        _fb = nullptr;
        _diff = nullptr;
        _dma_state = ILI9342_T4_DMA_IDLE;
        _last_delta = 0;         
        _timeframestart = 0;
        _last_y = 0;
    ...
    FLASHMEM bool ILI9342Driver::begin(uint32_t spi_clock, uint32_t spi_clock_read)
        {
        static const uint8_t init_commands[] = {
                                                 ...
                                                 2, 0xF7, 0x20,                             //
                                                 3, 0xEA, 0x00, 0x00,                       //
                                                 2, ILI9342_T4_PWCTR1, 0x23, // Power control 0x23 (or 0x20)
                                                 2, ILI9342_T4_PWCTR2, 0x10, // Power control
                                                 3, ILI9342_T4_VMCTR1, 0x3e, 0x28, // VCM control
                                                 2, ILI9342_T4_VMCTR2, 0x86, // VCM control2
                                                 2, ILI9342_T4_MADCTL, ILI9342_T4_MADCTL_MH | ILI9342_T4_MADCTL_BGR, // Memory Access Control
                                                 2, ILI9342_T4_PIXFMT, 0x55, 
                                                 3, ILI9342_T4_FRMCTR1, 0x00, 0x13, 
                                                 4, ILI9342_T4_DFUNCTR, 0x08, 0x82, 0x27, // Display Function Control
                                                 2, 0xF2, 0x00, // Gamma Function Disable
                                                 2, ILI9342_T4_GAMMASET, 0x01, // Gamma curve selected
                                                16, ILI9342_T4_GMCTRP1, 0x0F, 0x31, 0x2B, 0x0C, 0x0E, 0x08, 0x4E, 0xF1, 0x37, 0x07, 0x10, 0x03, 0x0E, 0x09, 0x00, // Set Gamma
                                                16, ILI9342_T4_GMCTRN1, 0x00, 0x0E, 0x14, 0x03, 0x11, 0x07, 0x31, 0xC1, 0x48, 0x08, 0x0F, 0x0C, 0x31, 0x36, 0x0F, // Set Gamma                                                                                             
        ...
        if (_touch_cs != 255)
            ...
            if (_touch_miso == 255)
                {
                _print("*** WARNING: Disabling the touchscreen because TOUCH_MISO is not correctly set ! ***\n\n ");
                _touch_cs = 255;
                _touch_irq = 255;
                _touch_miso = 255;
                }
            }
        if ((_touch_miso != 255) && (_touch_cs == 255))
            {
            _print("*** WARNING: Disabling the touchscreen because TOUCH_CS is not correctly set ! ***\n\n ");
            _touch_cs = 255;
            _touch_irq = 255;
            _touch_miso = 255;
            }
        ...
        if (spinum_MOSI < 0)
            {
            _printf("\n*** ERROR: SDA on pin %d is not a valid MOSI pin ! ***\n\n", _mosi);
            return false;
            }
        else _printf("- SDA on pin %d [SPI%d]\n", _mosi, spinum_MOSI);

        int spinum_MISO = -1; 
        if (_touch_miso != 255)
            {
            if (SPI.pinIsMISO(_touch_miso)) spinum_MISO = 0;  else if (SPI1.pinIsMISO(_touch_miso)) spinum_MISO = 1; else if (SPI2.pinIsMISO(_touch_miso)) spinum_MISO = 2;
            if (spinum_MISO < 0)
                {
                _printf("\n*** ERROR: MISO (for touchscreen) on pin %d is not a valid MISO pin  ***\n\n", _touch_miso);
                return false;
                } 
            else _printf("- MISO (for touchscreen) on pin %d [SPI%d]\n", _touch_miso, spinum_MISO);
            }
        else
            {
            //  miso not connected,  take default value. 
        ...
        if (spinum_SCK < 0)
            {
            _printf("\n*** ERROR: SCLK on pin %d is not a valid SPI SCLK pin ! ***\n\n", _sclk);
            return false;
            }
        else _printf("- SCLK on pin %d [SPI%d]\n", _sclk, spinum_SCK);

        if ((spinum_SCK != spinum_MISO) || (spinum_SCK != spinum_MOSI))
            {
            _printf("\n*** ERROR: SCLK, SDA (and MISO if used for touchscreen) must all be on the same SPI bus ! ***\n\n", _sclk);
            return false;
            }
        ...
        _pspi->setMOSI(_mosi);
        _pspi->setSCK(_sclk);
        if (_touch_miso != 255) _pspi->setMISO(_touch_miso);
        ...
        if (_cs < 255)
            ...
            {
            _print("- CS not connected to the Teensy (make sure CS is pulled down on the ILI9342 side...)\n");
            _csport = NULL; 
            }
        ...
        if (_spi_clock < 0) _spi_clock = ILI9342_T4_DEFAULT_SPICLOCK;
        _spi_clock_read = spi_clock_read;
        if (_spi_clock_read < 0) _spi_clock_read = ILI9342_T4_DEFAULT_SPICLOCK_READ;
        ...
        while(1)
            ...
            if (_rst < 255)
                ...
                for(int i=0; i<5; i++) _writecommand_cont(ILI9342_T4_NOP); // send NOPs
                _writecommand_last(ILI9342_T4_SWRESET); // issue a software reset
                _endSPITransaction();                   
                }
            delay(150); // mandatory !
            ...
            _writecommand_last(ILI9342_T4_SLPOUT); // Exit Sleep            
            _endSPITransaction();

            delay(150); // must wait for the screen to exit sleep mode. 
            _beginSPITransaction(_spi_clock / 4); // quarter speed for setup ! 
            _writecommand_last(ILI9342_T4_DISPON); // Display on
            _endSPITransaction();                      
            ...
            if (_halfduplex)
                ...
                int res_RDMODE = _readcommand8(ILI9342_T4_RDMODE);
                int res_RDPIXFMT = _readcommand8(ILI9342_T4_RDPIXFMT);
                int res_RDIMGFMT = _readcommand8(ILI9342_T4_RDIMGFMT);
                int res_RDSELFDIAG = _readcommand8(ILI9342_T4_RDSELFDIAG);
                ...
                if ((res_RDMODE == 0) && (res_RDPIXFMT == 0) && (res_RDIMGFMT == 0) && (res_RDSELFDIAG == 0))
                    ...
                    if (res_RDSELFDIAG != ILI9342_T4_SELFDIAG_OK)
                ...
                {
                _print("\nHalf duplex mode disabled. Cannot query the screen status (VSync disabled)...\n");
                }
            if (ok)
                {
            ...
            if (--r <= 0)
                {
                _print("\n*** CANNOT CONNECT TO ILI9342 SCREEN. ABORTING... ***\n\n");
                }
    ...
    FLASHMEM int ILI9342Driver::selfDiagStatus()
        {
        _waitUpdateAsyncComplete();
        resync();
        if (!_halfduplex) return 0; // return 0 
        return _readcommand8(ILI9342_T4_RDSELFDIAG);
        }


    FLASHMEM void ILI9342Driver::printStatus()
        {
        _waitUpdateAsyncComplete();
        _print("---------------- ILI9342Driver Status-----------------\n");
        if (!_halfduplex)
            {
            _print("\n*** Half duplex mode disabled: screen status cannot be queried ***\n\n");
            }
        else
            {
            uint8_t x = _readcommand8(ILI9342_T4_RDMODE);
            _print("- Display Power Mode  : 0x"); _println(x, HEX);
            x = _readcommand8(ILI9342_T4_RDMADCTL);
            _print("- MADCTL Mode         : 0x"); _println(x, HEX);
            x = _readcommand8(ILI9342_T4_RDPIXFMT);
            _print("- Pixel Format        : 0x"); _println(x, HEX);
            x = _readcommand8(ILI9342_T4_RDIMGFMT);
            _print("- Image Format        : 0x"); _println(x, HEX);
            x = _readcommand8(ILI9342_T4_RDSGNMODE);
            _print("- Display Signal Mode : 0x"); _println(x, HEX);
            x = _readcommand8(ILI9342_T4_RDSELFDIAG);
            _print("- Self Diagnostic     : 0x"); _print(x, HEX);
            if (x == ILI9342_T4_SELFDIAG_OK) _println(" [OK].\n"); else _println(" [ERROR].\n");
            }
        resync();
        }


    FLASHMEM void ILI9342Driver::setSpiClock(int spi_clock)
        {
        _waitUpdateAsyncComplete();
        _spi_clock = spi_clock;
        statsReset();
    ...
    FLASHMEM void ILI9342Driver::setSpiClockRead(int spi_clock)
        {
        _waitUpdateAsyncComplete();
    ...
    FLASHMEM void ILI9342Driver::setIRQPriority(int irq_priority)
        {
        _waitUpdateAsyncComplete();            
        noInterrupts();
    ...
    FLASHMEM void ILI9342Driver::setHalfDuplex(bool enable)
        {
        _waitUpdateAsyncComplete();
        noInterrupts();
        _halfduplex = enable;
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::sleep(bool enable)
        {
        _waitUpdateAsyncComplete();
        ...
        if (enable)
            {
            _writecommand_cont(ILI9342_T4_DISPOFF);
            _writecommand_last(ILI9342_T4_SLPIN);
            _endSPITransaction();
            delay(200);
            }
        else
            {
            _writecommand_cont(ILI9342_T4_DISPON);
            _writecommand_last(ILI9342_T4_SLPOUT);
            _endSPITransaction();
            delay(20);
            }
        resync();
    ...
    FLASHMEM void ILI9342Driver::invertDisplay(bool i)
        {
        _waitUpdateAsyncComplete();
        _beginSPITransaction(_spi_clock / 4); // quarter speed
        _writecommand_last(i ? ILI9342_T4_INVON : ILI9342_T4_INVOFF);
        _endSPITransaction();
        resync();
        }


    FLASHMEM void ILI9342Driver::setScroll(int offset)
        {
        if (offset < 0)
            {
            offset += (((-offset) / ILI9342_T4_TFTHEIGHT) + 1) * ILI9342_T4_TFTHEIGHT;
            }
        offset = offset % 320;
        _waitUpdateAsyncComplete();
        _beginSPITransaction(_spi_clock);
        _writecommand_cont(ILI9342_T4_VSCRSADD);
        _writedata16_cont(offset);
        _writecommand_cont(ILI9342_T4_RAMWR); // must send RAMWR because two consecutive VSCRSADD command may stall 
        _writecommand_last(ILI9342_T4_NOP);
        _endSPITransaction();
        }
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::setRotation(uint8_t m)
        {
        ...
        switch (m)
            ...
            case 3: // landscape 320x240
                _width = ILI9342_T4_TFTHEIGHT;
                _height = ILI9342_T4_TFTWIDTH;
                break;
            }
        resync();
        }
    ...
    * 
    * METHOD DISABLED BECAUSE
    * - ILI9342 always has refresh rate = 70 hz  (cannot be changed)
    * - ILI9342C has very few refresh rate (much more restricted than ILI9341) maximum 70Hz
    * 
    
    FLASHMEM void ILI9342Driver::setRefreshMode(int mode)
        {
        ...
        _waitUpdateAsyncComplete();
        _beginSPITransaction(_spi_clock / 4); // quarter speed 
        _writecommand_cont(ILI9342_T4_FRMCTR1); // Column addr set
    ...
    FLASHMEM void ILI9342Driver::setRefreshRate(float refreshrate_hz)
        {
    ...
    FLASHMEM void ILI9342Driver::printRefreshMode()
        {
        const int om = getRefreshMode();
        _print("------------ ILI9342Driver Refresh Modes -------------\n");
        if (!_halfduplex)
            {
            _print("*** WARNING The values displayed below are 'typical values' because exact rates cannot be queried since Half duplex moode is disabled ***\n");
            }
        for(int m = 0; m <= 31; m++)
            {
            setRefreshMode(m);
            float r = getRefreshRate();
            if (!_halfduplex) _printf("- mode %u : %fHz\n", m, r); else _printf("- mode %u : %fHz (%u FPS with vsync_spacing = 2).\n", m, r, (uint32_t)round(r/2));
            }
        _println("");
        setRefreshMode(om);
        }
    ...
    */
    ...
    int ILI9342Driver::_getScanLine(bool sync)
        {
        if (!sync)
            {
            return ( _synced_scanline + ((((uint64_t)_synced_em)* ILI9342_T4_NB_SCANLINES) / _period) ) % ILI9342_T4_NB_SCANLINES;
            }
    
        _beginSPITransaction(_spi_clock_read);

        _pimxrt_spi->CR = 0; // disable spi
        _pimxrt_spi->CFGR1 = LPSPI_CFGR1_MASTER | LPSPI_CFGR1_SAMPLE | LPSPI_CFGR1_PINCFG(2) | LPSPI_CFGR1_OUTCFG; // half duplex mode on the MISO pin. 
        _pimxrt_spi->CR = LPSPI_CR_MEN | LPSPI_CR_RRF | LPSPI_CR_RTF;

        _maybeUpdateTCR(_tcr_dc_assert | LPSPI_TCR_FRAMESZ(7));
        _pimxrt_spi->TDR = ILI9342_T4_GSLINE;  // send command
        while ((_pimxrt_spi->FSR & 0x1f));  // make sure command has been sent
        delayMicroseconds(3); // wait as requeted per manual

        while ((_pimxrt_spi->RSR & LPSPI_RSR_RXEMPTY) != 0); // wait until there is something to read
        __attribute__((unused)) uint32_t dummy = _pimxrt_spi->RDR; // Read back the command

        _maybeUpdateTCR(_tcr_dc_not_assert | LPSPI_TCR_FRAMESZ(16) | LPSPI_TCR_TXMSK); // start RX transfer

        while ((_pimxrt_spi->RSR & LPSPI_RSR_RXEMPTY) != 0); // wait until there is something to read
        uint32_t scline = _pimxrt_spi->RDR; // Read the scanline, 17 bits...

        _synced_em = 0;
        _synced_scanline = (scline > ILI9342_T4_TFTHEIGHT - 1) ? 0 : scline;  // save the scanline
    ...
    void ILI9342Driver::_sampleRefreshRate()
        {
        if (!_halfduplex)
            { // hack when half duplex mode disabled: approximate...
            _period = (uint32_t)round(1000000.0f / 70.0f); // default = 70Hz
            return;
            }
        ...
        while (_getScanLine(true) != 0)
            ...
            if (em > 1000000)
                { // hanging...
                em = 0;
                _println("\n\nILI9342_T4 : Hanging inside _sampleRefreshRate(), cannot get to scan line 0...");
                }
            }
        while (_getScanLine(true) == 0)
            {
            if (em > 1000000)
                { // hanging...
                em = 0;
                _println("\n\nILI9342_T4 : Hanging inside _sampleRefreshRate() cannot get to scan line 1...");
                }
            } 
        ...
        for (int i = 0; i < NB_SAMPLE_FRAMES; i++)
            ...
            while (_getScanLine(true) != 0)
                ...
                if (em > 1000000)
                    { // hanging...
                    em = 0;
                    _println("\n\nILI9342_T4 : Hanging inside _sampleRefreshRate(), cannot get to scan line 0 (bis)...");
                    }
                }
    ...
    float ILI9342Driver::_refreshRateForMode(int mode) const
        { 
    ...
    int ILI9342Driver::_modeForRefreshRate(float hz) const
        {
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::setVSyncSpacing(int vsync_spacing)
        {
        if (!_halfduplex)
            {
            if (vsync_spacing > 0)
                {// cannot use vsync if half duplex moode disabled 
                _printf("*** WARNING: setVSyncSpacing(%d) called while half duplex mode is disabled: reverting to vsync_spacing = 0 ***\n", vsync_spacing);
                vsync_spacing = 0; 
                }
            }
        _waitUpdateAsyncComplete();
        _vsync_spacing = ILI9342Driver::_clip<int>((int)vsync_spacing, (int)-1, (int)ILI9342_T4_MAX_VSYNC_SPACING);
        statsReset();
        resync();
        }


    FLASHMEM void ILI9342Driver::setLateStartRatio(float ratio)
        {
        _waitUpdateAsyncComplete(); // no need to wait for sync. 
        _late_start_ratio = ILI9342Driver::_clip<float>(ratio, 0.1f, 0.9f);
        statsReset();
        resync();
        }
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::setFramebuffer(uint16_t* fb1)
        {
        _waitUpdateAsyncComplete();
        _mirrorfb = nullptr; // complete redraw needed.
        _ongoingDiff = nullptr;
        _fb1 = fb1;        
        if (_fb1) memset(_fb1, 0, ILI9342_T4_NB_PIXELS*2);   
        resync();
        }
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::setDiffBuffers(DiffBuffBase* diff1, DiffBuffBase* diff2)
        {
        _waitUpdateAsyncComplete();
        if (diff1)
            {
    ...
    FLASHMEM void ILI9342Driver::setDiffGap(int gap)
        {
        _waitUpdateAsyncComplete();
        _diff_gap = ILI9342Driver::_clip<int>((int)gap, (int)2, (int)ILI9342_T4_NB_PIXELS);
        statsReset();
        resync();
        }


    FLASHMEM void ILI9342Driver::setDiffCompareMask(uint16_t mask)
        {
    ...
    FLASHMEM void ILI9342Driver::setDiffCompareMask(int bitskip_red, int bitskip_green, int bitskip_blue)
        {
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::clear(uint16_t color)
        {
        _waitUpdateAsyncComplete();    
        _beginSPITransaction(_spi_clock);
        _writecommand_cont(ILI9342_T4_PASET);
        _writedata16_cont(0);
        _writedata16_cont(ILI9342_T4_TFTHEIGHT-1);
        _writecommand_cont(ILI9342_T4_CASET);
        _writedata16_cont(0);
        _writedata16_cont(ILI9342_T4_TFTWIDTH-1);
        _writecommand_cont(ILI9342_T4_RAMWR);           
        for(int i=0; i < ILI9342_T4_NB_PIXELS; i++) _writedata16_cont(color);           
        _writecommand_last(ILI9342_T4_NOP); 
        _endSPITransaction();            
        if (_fb1)
            {
            for(int i=0; i < ILI9342_T4_NB_PIXELS; i++) _fb1[i] = color;
            _mirrorfb = _fb1;
            _ongoingDiff = nullptr;
            }
        resync();
    ...
    FLASHMEM void ILI9342Driver::updateRegion(bool redrawNow, const uint16_t* fb, int xmin, int xmax, int ymin, int ymax, int stride)
        {
                ...
                if (_diff2 == nullptr) // differential updates only with 2 diffs buffers.  
                    ...
                    if (redrawNow) 
                        ...
                        if (_mirrorfb)
                            ...
                            _flush_cache(_fb1, ILI9342_T4_NB_PIXELS * 2);
    ...
    FLASHMEM void ILI9342Driver::update(const uint16_t* fb, bool force_full_redraw)
        {
        if (fb == nullptr) return;
    ...
    void  ILI9342Driver::_pushpixels_mode0(const uint16_t* fb, int x, int y, int len)
        {
        const uint16_t* p = fb + x + (y * ILI9342_T4_TFTWIDTH);
        while (len-- > 0) { _writedata16_cont(*p++); }
        }


    void  ILI9342Driver::_pushpixels_mode1(const uint16_t* fb, int xx, int yy, int len)
        {
        int x = yy;
        int y = ILI9342_T4_TFTWIDTH - 1 - xx;
        while (len-- > 0)
            {
            _writedata16_cont(fb[x + ILI9342_T4_TFTHEIGHT*y]);
            y--;
            if (y < 0) { y = ILI9342_T4_TFTWIDTH - 1; x++; }
            }
        }


    void  ILI9342Driver::_pushpixels_mode2(const uint16_t* fb, int xx, int yy, int len)
        {
        int x = ILI9342_T4_TFTWIDTH - 1 - xx;
        int y = ILI9342_T4_TFTHEIGHT - 1 - yy;
        const uint16_t* p = fb + x + (y * ILI9342_T4_TFTWIDTH);
        while (len-- > 0) { _writedata16_cont(*p--); }
        }


    void  ILI9342Driver::_pushpixels_mode3(const uint16_t* fb, int xx, int yy, int len)
        {
        int x = ILI9342_T4_TFTHEIGHT - 1 - yy;
        int y = xx;    
        while (len-- > 0)
            {                     
            _writedata16_cont(fb[x + ILI9342_T4_TFTHEIGHT*y]);
            y++;
            if (y >= ILI9342_T4_TFTWIDTH) { y = 0; x--; }
            }
        }


    FLASHMEM void ILI9342Driver::_updateNow(const uint16_t* fb, DiffBuffBase* diff)
        {
        if ((fb == nullptr) || (diff == nullptr)) return;
        _waitUpdateAsyncComplete();
        _startframe(_vsync_spacing > 0);
        _margin = ILI9342_T4_NB_SCANLINES;
        ...
        if (_vsync_spacing > 0)
            ...
            int sc2 = sc1 + ((ILI9342_T4_NB_SCANLINES - 1 - sc1) * _late_start_ratio); // maximum 'late' scanline
        ...
        _writecommand_cont(ILI9342_T4_CASET);
        _writedata16_cont(x);
        _writedata16_cont(ILI9342_T4_TFTWIDTH);
        _writecommand_cont(ILI9342_T4_PASET);
        _writedata16_cont(y);
        _writedata16_last(ILI9342_T4_TFTHEIGHT);
        int prev_x = x;
        int prev_y = y;
        while (1)
            {
            int asl = (_vsync_spacing > 0) ? (_slinitpos + _nbScanlineDuring(_em_async)) : (2*ILI9342_T4_TFTHEIGHT);
            int r = diff->readDiff(x, y, len, asl);            
            if (r > 0)
                { // we must wait                             
                int t = _timeForScanlines(r - asl + 1);
                if (t < ILI9342_T4_MIN_WAIT_TIME) t = ILI9342_T4_MIN_WAIT_TIME;
                _pauseUploadTime();
                _delayMicro(t);
                _restartUploadTime();
                continue;
            ...
            if (_vsync_spacing > 0)
                {
                int m = (ILI9342_T4_TFTWIDTH*y + x + len)/ILI9342_T4_TFTWIDTH + ILI9342_T4_TFTHEIGHT - _slinitpos - _nbScanlineDuring(_em_async);
    ...
    FLASHMEM void ILI9342Driver::_updateRectNow(const uint16_t* sub_fb, int xmin, int xmax, int ymin, int ymax, int stride)
        {
        int x1, x2, y1, y2;
        ...
        switch (_rotation)
            {
            case LANDSCAPE_320x240: mdelta = 1; break;
            case PORTRAIT_240x230: mdelta = -stride; break;
            case LANDSCAPE_320x240_FLIPPED: mdelta = -1; break;
            case PORTRAIT_240x230_FLIPPED: mdelta = stride; break;
            }
        for (int yc = y1; yc <= y2; yc++)
            ...
            switch (_rotation)
                {
                case LANDSCAPE_320x240: m = stride * (yc - y1); break;
                case PORTRAIT_240x230: m = (yc - y1) + stride * (x2 - x1); break;
                case LANDSCAPE_320x240_FLIPPED: m = stride * (y2 - yc) + (x2 - x1); break;
                case PORTRAIT_240x230_FLIPPED: m = y2 - yc; break;
                }   
    ...
    FLASHMEM void ILI9342Driver::_pushRect(uint16_t color, int xmin, int xmax, int ymin, int ymax)
        {
        int x1, x2, y1, y2;
        DiffBuffBase::rotationBox(_rotation, xmin, xmax, ymin, ymax, x1, x2, y1, y2);
    ...
    FLASHMEM void ILI9342Driver::_updateAsync(const uint16_t* fb, DiffBuffBase* diff)
        {
        /*
        ...
        */
        ...
        _stats_nb_uploaded_pixels = 0;
        _margin = ILI9342_T4_NB_SCANLINES;
        _dma_state = ILI9342_T4_DMA_ON;
        _dmaObject[_spi_num] = this; // set up object callback.
        //_flush_cache(fb, 2 * ILI9342_T4_NB_PIXELS); // BEWARE THAT CACHE IF FLUSHED BEFORE CALLING THIS METHOD !
        _fb = fb;
        _diff = diff;                
        diff->initRead();
        int x = 0, y = 0, len = 0;        
        ...
        if (_vsync_spacing <= 0)
            ...
            _pauseUploadTime();
            _setTimerIn(1, &ILI9342Driver::_subFrameTimerStartcb); // call now
            }
        else
            { // time the call of the next method with vsync 
            _pauseUploadTime();
            _setTimerAt(_timeframestart + (_vsync_spacing - 1) * _period, &ILI9342Driver::_subFrameTimerStartcb); // call at start of screen refresh. 
            }
    ...
    FLASHMEM void ILI9342Driver::_subFrameTimerStartcb()
        {
        ...
        if (_vsync_spacing <= 0)
            {
            _pauseUploadTime();
            _setTimerIn(1, &ILI9342Driver::_subFrameTimerStartcb2);
            }
        else
            {
            int sc1 = _slinitpos;
            ...
            _pauseUploadTime();
            _setTimerIn(t, &ILI9342Driver::_subFrameTimerStartcb2); // call when ready to start transfer.        
            }
        _pauseCpuTime();
        return;
        }
    ...
    FLASHMEM void ILI9342Driver::_subFrameTimerStartcb2()
        {
        _restartUploadTime();
        _restartCpuTime();
        ...
        int x = 0, y = 0, len = 0;
        int asl = (_vsync_spacing > 0) ? _slinitpos  : (2 * ILI9342_T4_TFTHEIGHT);
        ...
        _last_y = (ILI9342_T4_TFTWIDTH * y + x + len) / ILI9342_T4_TFTWIDTH;
        _stats_nb_uploaded_pixels = len;

        _dmatx.sourceBuffer(_fb + x + (y * ILI9342_T4_TFTWIDTH), 2 * len);
        ...
        _dma_assert_dc();
        _pimxrt_spi->TDR = ILI9342_T4_RAMWR;
        _dma_deassert_dc();
    ...
    FLASHMEM void ILI9342Driver::_subFrameInterruptDiff()
        {
        if (_vsync_spacing > 0)
            { // check margin when using vsync
            int m = _last_y + ILI9342_T4_TFTHEIGHT - _slinitpos - _nbScanlineDuring(_em_async);
            if (m < _margin) _margin = m;
            }
        int x = 0, y = 0, len = 0;
        int asl = (_vsync_spacing > 0) ? (_slinitpos + _nbScanlineDuring(_em_async)) : (2 * ILI9342_T4_TFTHEIGHT);
        ...
        if (r < 0)
            ...
            */
            ...
            // _flush_cache(_fb, 2 * ILI9342_T4_NB_PIXELS);   /// NOT USEFUL AFTER NO ????
            _dmaObject[_spi_num] = nullptr;
            _dma_state = ILI9342_T4_DMA_IDLE;
            return;
            }
            ...
            //while (_pimxrt_spi->SR & LPSPI_SR_MBF); // wait while spi bus is busy. 
            _pauseUploadTime();
            _setTimerIn(t, &ILI9342Driver::_subFrameInterruptDiff2);
            _pauseCpuTime();            
            return;
            }
        // new instruction        
        if (_hardware_dc)
            ...
            if (x != _prev_caset_x)
                ...
                _pimxrt_spi->TDR = ILI9342_T4_CASET;
            ...
            if (y != _prev_paset_y)
                {
                _pimxrt_spi->TCR = _dma_spi_tcr_assert;
                _pimxrt_spi->TDR = ILI9342_T4_PASET;
                _pimxrt_spi->TCR = _dma_spi_tcr_deassert;
                _pimxrt_spi->TDR = y;
                _prev_paset_y = y;
                }
            ...
            const uint16_t* p = _fb + x + (y * ILI9342_T4_TFTWIDTH);
            _last_y = (ILI9342_T4_TFTWIDTH * y + x + len) / ILI9342_T4_TFTWIDTH;
            _stats_nb_uploaded_pixels += len;
            ...
            _spi_int_phase = 0;
            _spi_int_command[0] = ILI9342_T4_RAMWR;

            if (y != _prev_paset_y)
                {
                _spi_int_command[++_spi_int_phase] = y;
                _spi_int_command[++_spi_int_phase] = ILI9342_T4_PASET;
                _prev_paset_y = y;
                }
            if (x != _prev_caset_x)
                {
                _spi_int_command[++_spi_int_phase] = x;
                _spi_int_command[++_spi_int_phase] = ILI9342_T4_CASET;
                _prev_caset_x = x;
                }

            // prepare next DMA transfer
            _dmatx.sourceBuffer(_fb + x + (y * ILI9342_T4_TFTWIDTH), len * 2);
            _last_y = (ILI9342_T4_TFTWIDTH * y + x + len) / ILI9342_T4_TFTWIDTH;
            _stats_nb_uploaded_pixels += len;
    ...
    FLASHMEM void ILI9342Driver::_subFrameInterruptDiff2()
        {
    ...
    ***********************************************************************************************************/
    ...
    ILI9342Driver* volatile ILI9342Driver::_dmaObject[3] = { nullptr, nullptr, nullptr }; 


    FLASHMEM void ILI9342Driver::_dmaInterruptDiff()
        { 
        //noInterrupts();        // UNNEEDED ?
    ...
    ***********************************************************************************************************/
    ...
    ILI9342Driver* volatile ILI9342Driver::_pitObj[4] = {nullptr, nullptr, nullptr, nullptr};   // definition 

    FLASHMEM void ILI9342Driver::_timerinit()
        {
        _istimer = false; 
        for (int i = 0; i < 4; i++)
            {
        ...
        _print("\n *** TOO MANY INSTANCES OF ILI9342Driver CREATED ***\n\n");
        }
    ...
    ***********************************************************************************************************/
    ...
    void ILI9342Driver::_drawRect(int xmin, int xmax, int ymin, int ymax, uint16_t color)
        {
        _waitUpdateAsyncComplete();
        _beginSPITransaction(_spi_clock);
        _writecommand_cont(ILI9342_T4_PASET);
    ...
    uint8_t ILI9342Driver::_readcommand8(uint8_t c)
        {
        _beginSPITransaction(_spi_clock_read);
        ...
        _maybeUpdateTCR(_tcr_dc_assert | LPSPI_TCR_FRAMESZ(7));
        _pimxrt_spi->TDR = c;  // send command
        while ((_pimxrt_spi->FSR & 0x1f));  // make sure command has been sent

        while ((_pimxrt_spi->RSR & LPSPI_RSR_RXEMPTY) != 0); // wait until there is something to read
        __attribute__((unused)) uint32_t dummy = _pimxrt_spi->RDR; // Read back the command

        _maybeUpdateTCR(_tcr_dc_not_assert | LPSPI_TCR_FRAMESZ(7) | LPSPI_TCR_TXMSK); // start RX transfer

        while ((_pimxrt_spi->RSR & LPSPI_RSR_RXEMPTY) != 0); // wait until there is something to read
        uint32_t val = _pimxrt_spi->RDR; // Read the value
    ...
    void ILI9342Driver::_waitFifoNotFull()
        {
    ...
    void ILI9342Driver::_waitTransmitComplete()
        {           
        uint32_t tmp __attribute__((unused));
    ...
    ***********************************************************************************************************/
    ...
    uint32_t ILI9342Driver::_fetchbits_unsigned(const uint8_t* p, uint32_t index, uint32_t required)
        {
        uint32_t val;
    ...
    uint32_t ILI9342Driver::_fetchbits_signed(const uint8_t* p, uint32_t index, uint32_t required)
        {
    ...
    bool ILI9342Driver::_clipit(int& x, int& y, int& sx, int& sy, int & b_left, int & b_up, int lx, int ly)
        {
        b_left = 0;
        b_up = 0; 
    ...
    FLASHMEM void ILI9342Driver::_measureChar(char c, int pos_x, int pos_y, int& min_x, int& max_x, int& min_y, int& max_y, const void* pfont, int& xadvance)
        {
        const ILI9342_t3_font_t & font = *((const ILI9342_t3_font_t *)pfont);
        uint8_t n = (uint8_t)c;
    ...
    FLASHMEM void ILI9342Driver::_measureText(const char* text, int pos_x, int pos_y, int& min_x, int& max_x, int& min_y, int& max_y, const void * pfont, bool start_newline_at_0)
        {
        ...
        for (size_t i = 0; i < l; i++)
            ...
            if (c == '\n')
                {
                pos_x = startx;
                pos_y += ((const ILI9342_t3_font_t*)pfont)->line_space;
                }
            else
                {
                int xa = 0;
    ...
    FLASHMEM void ILI9342Driver::_drawTextILI(const char* text, int pos_x , int  pos_y, uint16_t col, const void * pfont, bool start_newline_at_0, int lx, int ly, int stride, uint16_t* buffer, float opacity)
        {
    ...
    FLASHMEM void ILI9342Driver::_drawCharILI(char c, int & pos_x, int & pos_y, uint16_t col, const void * pfont, int lx, int ly, int stride, uint16_t* buffer, float opacity)
        {
        const ILI9342_t3_font_t& font = *((const ILI9342_t3_font_t*)pfont);
        uint8_t n = (uint8_t)c;
        if ((n >= font.index1_first) && (n <= font.index1_last))
    ...
    FLASHMEM void ILI9342Driver::_drawCharBitmap_4BPP(const uint8_t* bitmap, int rsx, int b_up, int b_left, int sx, int sy, int x, int y, uint16_t col, int stride, uint16_t * buffer, float opacity)
        {
    ...
    FLASHMEM void ILI9342Driver::_fillRect(int xmin, int xmax, int ymin, int ymax, int lx, int ly, int stride, uint16_t* buffer, uint16_t color, float opacity)
        {
        if (opacity <= 0.0f) return;
        if (xmin < 0) xmin = 0; 
    ...
    FLASHMEM void ILI9342Driver::_uploadText(const char* text, int pos_x, int pos_y, uint16_t col, uint16_t col_bg, const void* pfont, bool start_newline_at_0)
        {
        const int startx = start_newline_at_0 ? 0 : pos_x;
        const size_t l = strlen(text);
        for (size_t i = 0; i < l; i++)
    ...
    FLASHMEM void ILI9342Driver::_uploadChar(char c, int& pos_x, int& pos_y, uint16_t col, uint16_t col_bg, const void* pfont)
        {
    ...
    FLASHMEM void ILI9342Driver::overlayText(uint16_t* fb, const char* text, int position, int line, int font_size,
                                             uint16_t fg_color, float fg_opacity,
                                             uint16_t bg_color, float bg_opacity,
                                             bool extend_bk_whole_width)
        {

        const ILI9342_t3_font_t * pfont;
        if (font_size < 12)
            pfont = &font_ILI9342_T4_OpenSans_Bold_10;
        else if (font_size < 14)
            pfont = &font_ILI9342_T4_OpenSans_Bold_12;
        else if (font_size < 16)
            pfont = &font_ILI9342_T4_OpenSans_Bold_14;
        else 
            pfont = &font_ILI9342_T4_OpenSans_Bold_16;
    ...
    FLASHMEM void ILI9342Driver::overlayFPS(uint16_t* fb, int position, uint16_t fg_color, uint16_t bg_color, float opacity)
        {
        char text[8] = "--- FPS";
        int text_off = 0;
    ...
    ***********************************************************************************************************/
    ...
    FLASHMEM void ILI9342Driver::statsReset()
        {
        _stats_nb_frame = 0;
    ...
    FLASHMEM void ILI9342Driver::printStats(bool diff_stats) const
        {
        if (_outputStream)
            {
            //_waitUpdateAsyncComplete();
            _print("----------------- ILI9342Driver Stats ----------------\n");

            _print("[Hardware]\n");
            _printf("- SPI BUS            : SPI%u [MOSI=%u, SCK=%u, CS=%u]\n", _spi_num, _mosi, _sclk, _cs );
            _print("- Half-duplex mode   : ");
            _print((_halfduplex) ? "enabled\n" : "disabled\n");
            ...
            if (_touch_cs == 255)
                ...
                {
                _printf("enabled [TOUCH_MISO=%u, TOUCH_CS=%u, TOUCH_IRQ=%u]\n", _touch_miso, _touch_cs, _touch_irq);
                }
            ...
            switch (getRotation())
                {
                case 0: _print("0 (LANSCAPE_320x240)\n"); break;
                case 1: _print("1 (PORTRAIT_240x320)\n"); break;
                case 2: _print("2 (LANSCAPE_320x240_FLIPPED)\n"); break;
                case 3: _print("3 (PORTRAIT_240x320_FLIPPED)\n"); break;
                }

            _printf("- refresh rate       : %.1fHz\n", getRefreshRate());
            int m = bufferingMode();
            ...
            if (!_halfduplex)
                {
                _print(" (VSYNC ALWAYS DISABLED BECAUSE HALF_DUPLEX DISABLED).\n");
                }
            else
                {
                if (_vsync_spacing <= 0)
    ...
    ***********************************************************************************************************/
    ...
    ILI9342Driver* volatile ILI9342Driver::_touchObjects[4] = { nullptr, nullptr, nullptr, nullptr };


    /** set the touch interrupt routine */
    FLASHMEM void ILI9342Driver::_setTouchInterrupt()
        {
        _touch_z_threshold = ILI9342_T4_TOUCH_Z_THRESHOLD;
    ...
    int32_t ILI9342Driver::lastTouched()
        {
    ...
    void ILI9342Driver::_updateTouch2()
        {
        ...
        if (z < _touch_z_threshold)
            {
            _touch_z = 0;
            if (z < ILI9342_T4_TOUCH_Z_THRESHOLD_INT)
                {
    ...
    void ILI9342Driver::_updateTouch()
        {
        if (_em_touched_read < ILI9342_T4_TOUCH_MSEC_THRESHOLD) return; // read not so long ago
    ...
    FLASHMEM bool ILI9342Driver::readTouch(int& x, int& y, int& z)
        {
        ...
        if (_touch_has_calibration)
            ...
            case 1:
                x = yy;
                y = ILI9342_T4_TFTWIDTH - 1 - xx;
                break;
            case 2:
                x = ILI9342_T4_TFTWIDTH - 1 - xx;
                y = ILI9342_T4_TFTHEIGHT - 1 - yy;
                break;
            case 3:
                x = ILI9342_T4_TFTHEIGHT - 1 - yy;
                y = xx;
                break;
                }
            }
    ...
    FLASHMEM bool ILI9342Driver::readTouch(int& x, int& y)
        {
        int z;
    ...
    int16_t ILI9342Driver::_besttwoavg(int16_t x, int16_t y, int16_t z)
        {
        int16_t da, db, dc;
        int16_t reta = 0;
    ...
    FLASHMEM void ILI9342Driver::setTouchCalibration(int touchCalibration[4])
        {
        if (touchCalibration)
            {
    ...
    FLASHMEM bool ILI9342Driver::getTouchCalibration(int touchCalibration[4])
        {
        if (_touch_has_calibration)
            {
    ...
    FLASHMEM void ILI9342Driver::_calibRect(int cx, int cy, int R, uint16_t col_ext, uint16_t col_int)
        {
        const int R1 = R / 2;
    ...
    FLASHMEM void ILI9342Driver::_calibTouch(int& x, int& y, int& z, int prv_x, int prv_y)
        {
    ...
    FLASHMEM void ILI9342Driver::calibrateTouch(int touchCalibration[4])
        {
        if (_touch_cs == 255)
            {
    ...
    restart_calib:
        ...
        for (int i = 0; i < 4; i++)
            ...
            clear(WHITE);         
            _uploadText("Touchscreen calibration", 62, 97, BLACK, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), true);
            _uploadText("Touch the center of the", 87, 135, BLUE, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_12), true);
            _uploadText("red square in the corner",85, 150, BLUE, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_12), true);
            _uploadText(tn, 140, 185, 31, 0xFFFF, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), true);            
            _printf("\n- corner %s: touch the center of the red rectangle... ", tn);
            switch (i)
                {
                case 0:
                    _calibRect(ILI9342_T4_TFTWIDTH - 1 - RADIUS, ILI9342_T4_TFTHEIGHT - 1 - RADIUS, RADIUS, BLUE, RED);
                    break;

                case 1:
                    _calibRect(RADIUS, ILI9342_T4_TFTHEIGHT - 1 - RADIUS, RADIUS, BLUE, RED);
                    break;
                ...
                case 3:
                    _calibRect(ILI9342_T4_TFTWIDTH - 1 - RADIUS, RADIUS, RADIUS, BLUE, RED);
                    break;
                }
            int j = (i + 2) % 4;
            delay(200);
        ...
        clear(WHITE);  
        _pushRect(BLACK, 2, 158, 200, 238);
        _pushRect(GREY, 4, 156, 202, 236);
        _pushRect(BLACK, 162, 317, 200, 238);
        _pushRect(GREY, 164, 315, 202, 236);
        _uploadText("GOOD", 57, 225, GREEN, GREY, (void*)(&font_ILI9342_T4_OpenSans_Bold_14), true);
        _uploadText("REDO CALIBRATION", 172, 225, RED, GREY, (void*)(&font_ILI9342_T4_OpenSans_Bold_14), true);
        _uploadText("Draw below to test calibration", 48, 15, BLACK, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_14), true);
        ...
        const float ex = ((float)ILI9342_T4_TFTWIDTH) / (ILI9342_T4_TFTWIDTH - 2*RADIUS);
        xa = xc + (xa - xc) * ex;
        xb = xc + (xb - xc) * ex;

        const float yc = (ya + yb) / 2;
        const float ey = ((float)ILI9342_T4_TFTHEIGHT) / (ILI9342_T4_TFTHEIGHT - 2*RADIUS);
        ya = yc + (ya - yc) * ey;
        yb = yc + (yb - yc) * ey;
            ...
            if (readTouch(x, y, z))
                ...
                if (y > 201)
                    ...
                    if (x < 157)
                        ...
                        _measureText(tt, 0, 0, minx, maxx, miny, maxy, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), false);
                        _uploadText("Calibration data:",90, 90, BLACK, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), true);
                        _uploadText(tt, 160 - (maxx - minx + 1)/2, 120, RED, WHITE, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), true);
                        _pushRect(BLACK, 123, 195, 200, 238);
                        _pushRect(GREY, 125, 193, 202, 236);
                        _uploadText("QUIT", 138, 225, BLACK, GREY, (void*)(&font_ILI9342_T4_OpenSans_Bold_16), true);
                        delay(300);
